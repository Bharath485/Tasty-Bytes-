...
|---|-------------|----------|-----------|
| 1 | PO_DISTRIBUTIONS_ALL | PO_DISTRIBUTIONS_ALL | Main Driver (with incremental filters) |
| 2 | PJF_PROJECTS_ALL_B | PJF_PROJECTS_ALL_B | Pre-joined with _TL |
| 3 | PJF_PROJECTS_ALL_TL | (joined in PJF_PROJECTS_ALL_B CTE) | - |
| 4 | PJF_PROJ_ELEMENTS_B | PJF_PROJ_ELEMENTS_B | Pre-joined with _TL |
| 5 | PJF_PROJ_ELEMENTS_TL | (joined in PJF_PROJ_ELEMENTS_B CTE) | - |
...
| 8 | IS_DELETE = 'N' (string filter) | PASS |
...
| 15 | LEFT OUTER JOIN used | PASS |
| 16 | Elements dual join condition | PASS |
