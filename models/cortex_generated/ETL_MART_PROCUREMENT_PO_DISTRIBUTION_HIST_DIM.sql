...
-------     ----------      ----------------      ----------------------------------
1.0         03/05/2026      Cortex Code           Initial Version - Auto-Generated from STTM (SCD2 Snapshot)
...
{% snapshot ETL_MART_PROCUREMENT_PO_DISTRIBUTION_HIST_DIM %}

{{
    config(
        description = 'Building ETL MART SCD2 table for PO_DISTRIBUTION_HIST_DIM',
        target_database = 'EDWPRD',
